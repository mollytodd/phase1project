...
function newCountryCard(selectedCountry) {
  ...
  saveButton.className = "cardButton";
  ...
  toggleButton.className = "cardButton";
  ...
  if (selectedCountry.coatOfArms && selectedCountry.coatOfArms.png) {
    pic.src = selectedCountry.coatOfArms.png;
  } else {
    pic.alt = "No Coat of Arms Available";
  } 
  ...
  languages.textContent = `Languages: ${Object.values(selectedCountry.languages).join(", ")}`
...
function displaySavedCountries(savedCountries) {
  const saveBar = document.querySelector("#saveBar");
  ...
  savedCountries.forEach((selectedCountry, index) => {
    ...
    countryName.className = "saveListName";

    const openButton = document.createElement("button");
    openButton.textContent = "Open";
    openButton.classList = "saveListButton";
    ...
    deleteButton.classList = "saveListButton";
    deleteButton.addEventListener('click', () => {
      deleteSavedItem(index);
      savedCountryDiv.remove();
    });
